...
public class ToAdapter extends RecyclerView.Adapter<ToAdapter.MyViewHolder> {
        ...
        public ToAdapter(List<Location> items, String startStationId) {
                data = items;
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
                ...
                holder.binding.getRoot().setOnClickListener(v -> {
                        ...
                        intent.putExtra("startStationId",startStationId);
                        intent.putExtra("endStationId",temperatureData.getId());
